  ...
  squad: {
    robot: {
      ...
      power: {
        attack: {
          base: 3,
          shell: { base: 0, bonuse: 0, percent: 100 },
          bonuse: 0
        }, // состояние усилителей базовых навіков
        defend: {
          base: 3,
          shell: { base: 0, bonuse: 0, percent: 100 },
          bonuse: 0
        }, // хранит уровень усилителя который добавляет очки
        life: {
          base: 5,
          shell: { base: 0, bonuse: 0, percent: 100 },
          bonuse: 0
        } // процент усилителя падает в ноль если бой проигран и растет на базе в мастерской N минут
      }
    },
    sniper: {
      name: 'base sniper',
