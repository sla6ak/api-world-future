...
const ru = {
  ...
  objects: {
    ...
    portal: {
      title: 'Портал',
      shortInfo:
        'Врата позволяют путешествовать по вселенной для прыжка вам необходимо находится возле врат',
      moreInfo:
        'Врата открывают портал в далеком космосе, тебе доступны путешествия в системы богатые ресурсами и аномалиями для исследования новых технологий но будь осторожен другая фракция хочет присвоить космос себе, для прыжка вам необходимо находится возле врат',
      distance
    },
